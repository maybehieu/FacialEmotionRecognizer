...
for epoch in range(EPOCHS):
    ...
    torch.save(model.state_dict(), os.path.join(
        CP_DIR, "cpt_epoch{}_valLoss{}_valAcc{}.pth".format(CONTINUE_EPOCH+epoch+1, epoch_valid_loss, epoch_valid_acc)))
    print("Saved checkpoint epoch{} with valLoss={} and valAcc={}".format(
